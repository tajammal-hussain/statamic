...
<head>
    ...
    <link rel="icon" type="image/png" href="javascript:void(0);" sizes="32x32">
    <link rel="icon" type="image/png" href="javascript:void(0);" sizes="16x16">
    <link rel="shortcut icon" type="image/x-icon" href="javascript:void(0);" sizes="16x16 32x32">
        ...
        <div class="global-header" bis_skin_checked="1">
            ...
            <div class="sm:px-8 w-full flex-1 lg:flex items-center lg:justify-center mx-auto max-w-full"
                ...
                <div class="global-search" bis_skin_checked="1">
                    ...
                    <input type="text" autocomplete="off" name="search" id="global-search" placeholder="Search..."
                        tabindex="-1" class="search-input">
            ...
            <div class="head-link h-full rtl:md:pl-6 ltr:md:pr-6 flex items-center justify-end">
                <div class="hidden md:block">
                    <div class="relative">
                        ...
                        <div id="dropdown-content1"
                            class="dropdown-content absolute hidden text-gray-700 pt-1 right-2">
                ...
                <div class="relative">
                    ...
                    <div id="dropdown-content2" class="dropdown-content absolute hidden text-gray-700 pt-1 right-2">
                        <div class="bg-white shadow-popover rounded-md w-48" bis_skin_checked="1">
                            ...
                            <a href="javascript:void(0);"
                                class="rounded-b hover:bg-gray-200 py-2 px-4 block whitespace-no-wrap">CP Nav</a>
                        </div>
                    </div>
                </div>
                <div class="relative">
                ...
                <div class="relative ">
                    <div class="dropdown inline-block relative">
                        <button id="dropdown4"
                            class="md:block h-10 w-10 rtl:mr-4 ltr:ml-4 p-1 text-gray hover:text-gray-800 ">
                            <div class="rounded-full hover:shadow-md"><img class="rounded-full hover:shadow-xl"
                                    src="{{ asset('imgs/cedar_technologiess_logo.jpg') }}"></div>
                        </button>
                    </div>
                        ...
                        <div class="w-64 bg-white shadow-popover rounded-md">
                            <div class="px-2 border-b">
                                <div class="rounded-t text-base mb-px py-2 px-4 whitespace-no-wrap font-semibold">
                                    david.hasselhoff@example.com</div>
                            </div>
                            <div class="flex flex-col">
                                <a href="javascript:void(0);"
                                    class="hover:bg-gray-200 py-2 px-4 whitespace-no-wrap">Profile</a>
                                <a href="javascript:void(0);"
                                    class="rounded-b hover:bg-gray-200 py-2 px-4 whitespace-no-wrap">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
