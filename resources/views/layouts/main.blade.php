        ...
        <div class="head-link h-full rtl:md:pl-6 ltr:md:pr-6 flex items-center justify-end" bis_skin_checked="1">
            <div class="hidden md:block" bis_skin_checked="1">
                <div class="" bis_skin_checked="1">
                    <div aria-haspopup="true" bis_skin_checked="1"><button slot="reference" aria-label="Pin to Favorites" class="h-6 w-6 block outline-none p-1 text-gray hover:text-gray-800 v-popper--has-tooltip">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke-width="3"
                                    viewBox="0 0 48 48">
                ...
                <div class="v-portal" style="display: none;" bis_skin_checked="1"></div>
            </div> <a href="javascript:void(0);" target="_blank" aria-label="View Site"
            ...
            <div class="" bis_skin_checked="1">
                <div class="popover" bis_skin_checked="1">
                    <div class="popover-content bg-white shadow-popover rounded-md" bis_skin_checked="1">
                        ...
                        <a href="javascript:void(0);">CP Nav</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="" bis_skin_checked="1">
                <div class="popover" bis_skin_checked="1" style="transform: translate(1042px, 225px);">
                    <div class="popover-content bg-white shadow-popover rounded-md" bis_skin_checked="1">
                        ...
                        <a href="javascript:void(0);">EditBlueprints</a>
                    </div>
                </div>
            </div>
        </div>
