...
<head>
    ...
    <link rel="icon" type="image/png"
          href="javascript:void(0);" sizes="32x32">
    <link rel="icon" type="image/png"
          href="javascript:void(0);" sizes="16x16">
    <link rel="shortcut icon" type="image/x-icon"
          href="javascript:void(0);" sizes="16x16 32x32">
...
<body>
    <div id="statamic" bis_skin_checked="1">
        ...
        {{-- Site Logo --}}
        <div class="lg:min-w-xl rtl:pr-2 ltr:pl-2 rtl:md:pr-6 ltr:md:pl-6 h-full flex items-center" bis_skin_checked="1">
            <button aria-label="Toggle Nav" class="nav-toggle hidden md:flex rtl:mr-1 ltr:ml-1 shrink-0">
            ...
            <button aria-label="Toggle Mobile Nav" class="nav-toggle md:hidden rtl:mr-1 ltr:ml-1 shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-4 w-4">
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2.25 18.003h19.5m-19.5-6h19.5m-19.5-6h19.5"></path>
                </svg>
            </button>
            <a href="javascript:void(0);" class="flex items-end">
                <div class="hidden md:block shrink-0 v-popper--has-tooltip" bis_skin_checked="1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 17.43" class="w-24">
                        <path fill="#3C4858"
                    ...
                    <span class="font-bold text-4xs align-top">PRO</span>
                </div>
            </a>
        </div>
        ...
        <div class="sm:px-8 w-full flex-1 lg:flex items-center lg:justify-center mx-auto max-w-full"
            ...
            <div class="global-search" bis_skin_checked="1">
                <div class="state-container w-4 h-4 text-gray-500 flex items-center" bis_skin_checked="1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-4 h-4">
                        <circle cx="9.813" cy="9.812" r="9.063" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" transform="rotate(-23.025 9.813 9.812)"></circle>
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m16.221 16.22 7.029 7.03"></path>
                    </svg>
                </div>
                
                <label for="global-search" class="sr-only">Global Search</label>
                <input type="text" autocomplete="off" name="search" id="global-search" placeholder="Search..." tabindex="-1" class="search-input">
                <span class="rounded px-1 pb-px text-2xs border text-gray-600">/</span>
            ...
            <div class="hidden md:block">
                <div class="relative">
                    <div class="dropdown inline-block relative">
                        <button id="dropdown1" slot="reference" aria-label="Pin to Favorites" class="h-6 w-6 block outline-none p-1 text-gray hover:text-gray-800 v-popper--has-tooltip">
                        ...
                        <div id="dropdown-content1" class="dropdown-content absolute hidden text-gray-700 pt-1 right-2">
                            <div class="bg-white shadow-popover rounded-md">
                                <div class="p-4 pb-2">
                                    ...
                                    <button class="mt-2 text-xs text-blue outline-none hover:text-blue-800">Set as start page<span>→</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative">
                    <div class="dropdown inline-block relative">
                        <button id="dropdown2" aria-label="Manage Preferences" class="hidden md:block h-6 w-6 rtl:mr-4 ltr:ml-4 p-1 text-gray hover:text-gray-800">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <circle cx="12" cy="12.001" r="4.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></circle>
                            </svg>
                        </button>
                    </div>
                    <div id="dropdown-content2" class="dropdown-content absolute hidden text-gray-700 pt-1 right-2">
                        <div class="bg-white shadow-popover rounded-md w-48" bis_skin_checked="1">
                            <a href="javascript:void(0);" class="rounded-t hover:bg-gray-200 py-2 px-4 block whitespace-no-wrap">Preferences</a>
                            <a href="javascript:void(0);" class="rounded-b hover:bg-gray-200 py-2 px-4 block whitespace-no-wrap">CP Nav</a>
                        </div>
                    </div>
                </div>
                <div class="relative">
                    <div class="dropdown inline-block relative">
                        <button id="dropdown3" aria-label="View Useful Links" class="hidden md:block h-6 w-6 rtl:mr-4 ltr:ml-4 p-1 text-gray hover:text-gray-800 v-popper--has-tooltip">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                    ...
                    <div id="dropdown-content3" class="dropdown-content absolute hidden text-gray-700 pt-1 right-2">
                        <div class=" w-48 bg-white shadow-popover rounded-md">
                            <a href="javascript:void(0);" target="_blank" class="flex rounded-t hover:bg-gray-200 py-2 px-4 whitespace-no-wrap"><span>Documentation</span>
                            ...
                            <a href="javascript:void(0);" target="_blank" class="flex hover:bg-gray-200 py-2 px-4 whitespace-no-wrap"><span>Support</span>
                                <i class="w-3 block rtl:mr-2 ltr:ml-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                            d="M23.251 7.498V.748h-6.75m6.75 0-15 15m3-10.5h-9a1.5 1.5 0 0 0-1.5 1.5v15a1.5 1.5 0 0 0 1.5 1.5h15a1.5 1.5 0 0 0 1.5-1.5v-9">
                            ...
                            <a class="flex hover:bg-gray-200 py-2 px-4 whitespace-no-wrap"><span>Keyboard Shortcuts</span></a>
                        </div>
                    </div>
                </div>
                <a href="javascript:void(0);" target="_blank" aria-label="View Site" class="hidden md:block h-6 w-6 p-1 text-gray rtl:mr-4 ltr:ml-4 hover:text-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <div class="relative ">
                    <div class="dropdown inline-block relative">
                        <button id="dropdown4" class="md:block h-10 w-10 rtl:mr-4 ltr:ml-4 p-1 text-gray hover:text-gray-800 ">
                            <div class="rounded-full hover:shadow-md"><img class="rounded-full hover:shadow-xl" src="{{ asset('imgs/cedar_technologiess_logo.jpg') }}"></div>
                        </button>
                    </div>
                    <div id="dropdown-content4" class="dropdown-content absolute hidden text-gray-700 pt-1 right-2">
                        <div class="w-64 bg-white shadow-popover rounded-md">
                            <div class="px-2 border-b">
                                <div class="rounded-t text-base mb-px py-2 px-4 whitespace-no-wrap font-semibold">david.hasselhoff@example.com</div>
                            </div>
                            <div class="flex flex-col">
                                <a href="javascript:void(0);" class="hover:bg-gray-200 py-2 px-4 whitespace-no-wrap">Profile</a>
                                <a href="javascript:void(0);" class="rounded-b hover:bg-gray-200 py-2 px-4 whitespace-no-wrap">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
