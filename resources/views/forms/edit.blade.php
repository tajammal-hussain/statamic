...
@section('content')
    <div class="page-wrapper max-w-xl">
        <div initial-title="Contact" listing-url="">
            <form id="myForm" action="{{ route('forms.update', ['form' => $form->handle]) }}" method="post">
                @csrf
                @method('put')
                <header class="mb-6">
                            ...
                            <div class="publish-sections">
                                <div class="publish-sections-section">
                                    <div class="p-0 card">
                                        <div class="publish-fields @container">
                                            <div
                                                class="form-group publish-field publish-field__honeypot text-fieldtype w-full">
                                                <div class="field-inner"><label for="field_honeypot"
                                                    ...
                                                    <div class="help-block -mt-2">
                                                        <p>Field name to use as a honeypot. Honeypots are special fields
                                                            used to
                                                            reduce botspam.
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="flex items-center">
                                                    <div class="input-group"><input id="field_honeypot" name="honeypot"
                                                            type="text" class="input-text"
                                                            value="{{ json_decode($form->settings) != null ? json_decode($form->settings)->honeypot : '' }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="publish-sections">
                                <div class="publish-sections-section">
                                    <div class="p-0 card">
                                        <div class="publish-fields @container">
                                            <div
                                                class="form-group publish-field publish-field__store toggle-fieldtype w-full">
                                                <div class="field-inner">
                                                    <input type="hidden" name="storeSubmission" id="storeSubmission">
                                                    <label for="field_store" class="publish-field-label">
                                                        <span class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Store
                                                            Submissions</span>
                                                        <button class="outline-none" style="display: none;">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                                class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                                    ...
                                                    <div class="help-block -mt-2">
                                                        <p>Disable to stop storing submissions. Events and email
                                                            notifications
                                                            will still be
                                                            sent.
                                                        </p>
                            ...
                            <div class="publish-sections">
                                <div class="publish-sections-section">
                                    <div class="p-0 card">
                                        <div class="publish-fields @container">
                                            <div
                                                class="form-group publish-field publish-field__email grid-fieldtype w-full">
                                                <div class="field-inner"><label for="field_email"
                                                        class="publish-field-label"><span
                                                    ...
                                                    <div class="help-block -mt-2">
                                                        <p>Configure emails to be sent when new form submission are
                                                            received.
                                                        </p>
                                                    </div>
                                                </div>
                                                        ...
                                                        <section class="">
                                                            <div>
                                                                <div
                                                                    ...
                                                                    <button
                                                                        class="btn btn-icon flex items-center v-popper--has-tooltip">
    ...
    <script>
        $('#myForm').submit(function() {
            ...
            let isStoreSubmission = $('#field_store').attr('aria-pressed');
            $('#storeSubmission').val(isStoreSubmission === 'true' ? '1' : '0');
