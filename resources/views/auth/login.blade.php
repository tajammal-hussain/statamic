...
<head>
  ...
  <title>Log in ‹ Cedar</title>

  <link rel="icon" type="image/png" href="https://demo.statamic.com/vendor/statamic/cp/build/assets/favicon-32x32-c29eba9f.png" sizes="32x32">
  <link rel="icon" type="image/png" href="https://demo.statamic.com/vendor/statamic/cp/build/assets/favicon-16x16-a15cab2f.png" sizes="16x16">
  <link rel="shortcut icon" type="image/x-icon" href="https://demo.statamic.com/vendor/statamic/cp/build/assets/favicon-bbfe21cf.ico" sizes="16x16 32x32">
...
<body class="outside rad-theme "
  ...
  <div id="statamic" bis_skin_checked="1">
    ...
    <div class="card auth-card mx-auto" bis_skin_checked="1">
      <div bis_skin_checked="1">
        <form method="POST" class="email-login select-none"><input type="hidden" name="_token"
            value="i4B1v7SGT4VA4A3Dd73cbmRFqDopFWPUenz6FVQe"> <input type="hidden" name="referer"
            value="https://statamic.com/">
          <div class="mb-8" bis_skin_checked="1"><label for="input-email" class="mb-2">Email</label> <input type="text"
              name="email" value="" autofocus="autofocus" id="input-email" class="input-text input-text"></div>
          <div class="mb-8" bis_skin_checked="1"><label for="input-password" class="mb-2">Password</label> <input
              type="password" name="password" id="input-password" class="input-text input-text"></div>
          <div class="flex justify-between items-center" bis_skin_checked="1"><label for="remember-me"
              class="flex items-center cursor-pointer"><input type="checkbox" name="remember" id="remember-me"> <span
                class="rtl:mr-2 ltr:ml-2">Remember me</span></label> <button type="submit" class="btn-primary">Log
              in</button></div>
        </form>
      </div>
    </div>
    <div class="w-full text-center mt-4" bis_skin_checked="1"><a href="#"
  ...
  <script src="data:text/javascript;base64,U3RhdGFtaWMuY29uZmlnKFN0YXRhbWljQ29uZmlnKTsgU3RhdGFtaWMuc3RhcnQoKQ=="
    defer=""></script>
  ...
  <div id="draggable-live-region" aria-relevant="additions" aria-atomic="true" aria-live="assertive" role="log"
    style="position: fixed; width: 1px; height: 1px; top: -1px; overflow: hidden;" bis_skin_checked="1"></div>
            ...
            <div class="sidebar-entry-btn-hvXPZj sidebar-entry-btn-right-doBuCO"
              ...
              <div class="float-btn-box-yen8CN">
                <div class="float-btn-dmQyFz"><img
                    ...
                    class="logo-img-drxdFH" alt="" style="width: 24px; height: 24px; border-radius: 4px;"><span
