        ...
        <div class="card auth-card mx-auto" bis_skin_checked="1">
            <div bis_skin_checked="1">
                <form method="POST" class="email-login select-none"><input type="hidden" name="_token"
                    ...
                    <div class="mb-8" bis_skin_checked="1"><label for="input-email" class="mb-2">Email</label>
                        <input type="text" name="email" value="" autofocus="autofocus" id="input-email"
                            class="input-text input-text"></div>
                    <div class="mb-8" bis_skin_checked="1"><label for="input-password" class="mb-2">Password</label>
                        <input type="password" name="password" id="input-password" class="input-text input-text"></div>
                    <div class="flex justify-between items-center" bis_skin_checked="1"><label for="remember-me"
                            class="flex items-center cursor-pointer"><input type="checkbox" name="remember"
                                id="remember-me"> <span class="rtl:mr-2 ltr:ml-2">Remember me</span></label> <button
                            type="submit" class="btn-primary">Log
                            in</button></div>
                </form>
            </div>
        </div>
