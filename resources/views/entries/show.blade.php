                                                ...
                                                <div class="p-0 card">
                                                    <div class="publish-fields @container">
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <textarea readonly name="content" id="editor">{{ json_decode($entry->data)->content }}</textarea>
                                                            </div><!----><!---->
                                                        </div>
                                                        <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="field-inner">
                                                                <input type="hidden" name="enableState"
                                                                    id="enableState">
                                                                <label for="field_enabled" class="publish-field-label">
                                                                    <span
                                                        ...
                                                        <div
                                                            ...
                                                            {{-- @foreach ($taxonomyTerms as $taxonomy => $collection)
                                                                    <div class="mt-4">
                                                                        ...
                                                                        <div x-data="dropdown('{{ $taxonomy }}')"
                                                                            x-init="loadOptions('{{ $taxonomy }}')" class="w-full">
                                                                            <input name="{{ $taxonomy }}"
                                                                                type="hidden"
