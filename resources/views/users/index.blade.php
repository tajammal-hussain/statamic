                    ...
                    <div class="flex flex-wrap items-center justify-between px-2 pb-2 text-sm border-b"
                        ...
                        <div class="pt-2 rtl:pl-2 ltr:pr-2" bis_skin_checked="1">
                            <div class="flex flex-wrap items-center" bis_skin_checked="1">
                                <button
                                        class="pill-tab rtl:ml-1 ltr:mr-1 active">All
                                </button>
                                <button
                                        class="pill-tab v-popper--has-tooltip">
                        ...
                        <div class="flex space-x-2 mt-2" bis_skin_checked="1">
                            <button class="btn btn-sm rtl:mr-2 ltr:ml-2"
                    ...
                    <div class="shadow-inner bg-gray-300" bis_skin_checked="1">
                        <div class="flex items-center flex-wrap px-3 border-b pt-2" bis_skin_checked="1">
                            <div class="" bis_skin_checked="1">
                                <div aria-haspopup="true" bis_skin_checked="1">
                                    <button
                                            class="filter-badge filter-badge-control rtl:ml-2 ltr:mr-2 mb-2"> Field
                                        <svg
                            ...
                            <div class="" bis_skin_checked="1">
                                <div aria-haspopup="true" bis_skin_checked="1">
                                    <button
                                            class="filter-badge filter-badge-control rtl:ml-2 ltr:mr-2 mb-2"> Role
                                        <svg
                                                viewBox="0 0 10 6.5" class="w-2 h-2 mx-2">
                                            <path fill="currentColor"
                                                  d="M9.9 1.4 5 6.4l-5-5L1.4 0 5 3.5 8.5 0l1.4 1.4z">
                                ...
                                <tr class="sortable-row outline-none" tabindex="0"><!---->
                                        ...
                                        <td class="">
                                            <div class="role-index-field" bis_skin_checked="1"><!----><!---->
                                                <div class="role-index-field-item rtl:ml-1 ltr:mr-1 mb-1.5"
                                                     bis_skin_checked="1"> {{ $role->roleName }}
                                                </div>
                                            </div>
                                        </td>
                                    @endforeach
                                    <td class="">
                                        <div bis_skin_checked="1">
                                            <div handle="last_login" values="[object Object]" class=""
                                                 @php
                                                     // Parse the last login time using Carbon
                                                     $lastLogin = Carbon::parse($user->last_login);

                                                     // Get the current time
                                                     $currentTime = Carbon::now();

                                                     // Calculate the duration between last login and current time
                                                     $duration = $lastLogin->diffForHumans($currentTime);
                                                 @endphp
                                                 bis_skin_checked="1">{{ ($user->last_login) ? $duration : "never" }}</div>
                                        </div>
                                    </td><!---->
                                    <th class="actions-column">
                                        <div class="dropdown-list" bis_skin_checked="1">
                                            <div aria-haspopup="true" bis_skin_checked="1">
                                                <button
                                                        aria-label="Open Dropdown" class="rotating-dots-button">
                                                    <svg
