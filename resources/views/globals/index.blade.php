                ...
                <div class="card rounded-xl text-center p-6 lg:py-10">
                    ...
                    <div class="hidden md:block"><svg width="163" height="141" viewBox="0 0 163 141" fill="none"
                            ...
                            <path
                                ...
                                fill="white"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M38.1207 26.1555H31.1567V25.1205H38.1207V26.1555Z" fill="#989FB0"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M38.1207 28.9155H31.1567V27.8805H38.1207V28.9155Z" fill="#989FB0"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M35.9143 31.6754H31.1567V30.6404H35.9143V31.6754Z" fill="#989FB0"></path>
                            <defs>
                                <filter id="filter0_d_18_6329" x="0.95166" y="4.90906" width="161.698" height="136.045"
                                    ...
                                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_18_6329"
                                        result="shape">
                                    </feBlend>
                                </filter>
                                <linearGradient id="paint0_linear_18_6329" x1="81.7621" y1="13.78" x2="81.7621"
                                    y2="108.947" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#FDFEFF"></stop>
                                    <stop offset="0.9964" stop-color="#ECF0F5"></stop>
                                </linearGradient>
                                <linearGradient id="paint1_linear_18_6329" x1="107.245" y1="26.8434" x2="48.3469"
                                    y2="29.8617" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#B0BACC"></stop>
                                    <stop offset="1" stop-color="#969EAE"></stop>
                                </linearGradient>
                                <linearGradient id="paint2_linear_18_6329" x1="130.148" y1="86.114" x2="49.7178"
                                    y2="94.4567" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#B0BACC"></stop>
                                    <stop offset="1" stop-color="#969EAE"></stop>
                                </linearGradient>
                                <linearGradient id="paint3_linear_18_6329" x1="102.205" y1="94.7389" x2="48.2241"
                                    y2="98.4747" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#B0BACC"></stop>
                                    <stop offset="1" stop-color="#969EAE"></stop>
                                </linearGradient>
                            </defs>
