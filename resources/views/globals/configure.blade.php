...
@section('content')
    <title>Globals configure :: Cedar</title>
    <div class="page-wrapper max-w-xl">
          <header class="mb-6">
            <div class="flex"><a href="https://demo.statamic.com/cp/globals/company"
          ...
          <div>
                          ...
                          <div class="form-group publish-field publish-field__title text-fieldtype w-full">
                            <div class="field-inner"><label for="field_title" class="publish-field-label"><span
                              ...
                              <div class="help-block -mt-2">
                                <p>We recommend a noun representing the set's contents. eg. "Brand" or "Company"</p>
                              </div>
                            </div><!---->
                            <div class="flex items-center">
                              <div class="input-group"><!----><input id="field_title" name="title" type="text"
                                  autofocus="autofocus" class="input-text" value="Company"><!----></div><!---->
                            </div><!----><!---->
                          </div>
                        </div>
                      </div>
            ...
            <div class="py-4 border-t flex justify-between"><a href="https://demo.statamic.com/cp/globals/company"
