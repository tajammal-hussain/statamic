...
@section('content')
    <div class="page-wrapper max-w-3xl">
        <div>
            <form id="myForm" method="POST"
                action="{{ route('terms.update', ['taxonomy' => $terms->taxonomy, 'id' => $terms->id]) }}">
                @csrf
                @method('put')
                <div class="breadcrumb flex">
                    <a href="javascript:void(0);" class="flex-initial flex p-2 -m-2 items-center text-xs text-gray-700 hover:text-gray-900">
                        ...
                        </svg><span>{{ $terms->title }}</span></a>
                </div>
                <div class="flex items-center mb-6">
                    <h1 class="flex-1">
                        <div class="flex items-center"><span
                                class="little-dot rtl:ml-2 ltr:mr-2 published v-popper--has-tooltip"></span><span>{{ $terms->title }}</span>
                        </div>
                    </h1>
                                                                ...
                                                                <div class="flex items-center">
                                                                    <div class="input-group">
                                                                        <input id="field_title" name="title"
                                                                            ...
                                                                            class="input-text" value="{{ $terms->title }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div>
                                                                    <textarea name="content" id="editor">{{ json_decode($terms->data)->content }}</textarea>
                                                                </div><!----><!---->
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    @php
        $metaData = json_decode($terms->data)->metaData ?? false;
    @endphp
    <script>
        const submitFormUrl = "{{ route('terms.update', ['id' => $terms->id, 'taxonomy' => $terms->taxonomy]) }}";
