    ...
    <div class="page-wrapper max-w-xl">
        <div class="max-w-lg mt-4 mx-auto">
            <div class="rounded p-6 lg:px-20 lg:py-10 shadow bg-white">
                ...
                @endif
                <form action="{{ route('navigations.add') }}" method="POST">
                    @csrf
                    <div class="mb-10">

                        <label for="title" class="font-bold text-base mb-1">Title</label><input type="text"
                                                                                                autofocus="autofocus"
                                                                                                tabindex="1"
                                                                                                class="input-text"
                                                                                                value="{{ old('title') }}"
                                                                                                ...
                                                                                                id="title" name="title">
                        <div class="text-2xs text-gray-600 mt-2 flex items-center"> We recommend a name that matches
                            where
                            it
                            will be used, like "Main Nav" or "Footer Nav".
                        </div>
                    </div>
                    <div class="mb-4"><label for="handle" class="font-bold text-base mb-1">Handle</label><input
                                type="text"
                                tabindex="2"
                                class="input-text"
                                type="text" id="handle" name="handle"
                                value="{{ old('handle') }}" placeholder="Enter handle" readonly>
                        <div class="text-2xs text-gray-600 mt-2 flex items-center"> Used to reference this navigation on
                            the
            ...
            <div class="flex justify-center mt-8">
                <button tabindex="4"
                        class="btn-primary mx-auto btn-lg"> Create Navigation
                </button>
            </div>
        </div>
    </div>
