...
@section('content')
    ...
    <div class="page-wrapper max-w-xl">
        <div>
            <header class="mb-6">
                <div class="breadcrumb flex"><a href="https://demo.statamic.com/cp/navigation"
                        ...
                        </svg><span>Navigation</span></a></div>
                <div class="flex items-center">
                    <h1 class="flex-1">Footer</h1><!----><!----><!---->
                    <div class="dropdown-list">
                        <div aria-haspopup="true"><button class="btn flex items-center rtl:pl-4 ltr:pr-4"> Add Nav Item <svg
                                        viewBox="0 0 10 6.5" class="w-2 rtl:mr-4 ltr:ml-4">
                                    <path fill="currentColor" d="M9.9 1.4 5 6.4l-5-5L1.4 0 5 3.5 8.5 0l1.4 1.4z"></path>
                                </svg></button></div>
                        <div class="v-portal" style="display: none;"></div>
                    </div><button disabled="disabled" class="btn-primary rtl:mr-4 ltr:ml-4 disabled">Save Changes</button>
                </div>
            </header>
            <div>
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="flex items-center flex-1 p-2 rtl:mr-2 ltr:ml-2 text-xs leading-normal">
                                                    <div class="flex items-center grow">
                                                        ...
                                                        </div><!----><a class="text-sm font-medium">Neat Guy</a><!----><!----><!---->
                                                    </div>
                                                    <div class="rtl:pl-2 ltr:pr-2 flex items-center"><!----><!----><!----><svg
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="flex items-center flex-1 p-2 rtl:mr-2 ltr:ml-2 text-xs leading-normal">
                                                    <div class="flex items-center grow">
                                                        <div
                                                                class="little-dot rtl:ml-2 ltr:mr-2 bg-transparent border border-gray-600 v-popper--has-tooltip">
                                                        </div><!----><a class="text-sm font-medium">Neat CMS</a><!----><!----><!---->
                                                    </div>
                                                    <div class="rtl:pl-2 ltr:pr-2 flex items-center"><!----><!----><!----><svg
                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                                class="inline-block w-4 h-4 text-gray-500 v-popper--has-tooltip">
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="flex items-center flex-1 p-2 rtl:mr-2 ltr:ml-2 text-xs leading-normal">
                                                    <div class="flex items-center grow">
                                                        <div
                                                                class="little-dot rtl:ml-2 ltr:mr-2 bg-transparent border border-gray-600 v-popper--has-tooltip">
                                                        </div><!----><a class="text-sm font-medium">Neat Walk</a><!----><!----><!---->
                                                    </div>
                                                    <div class="rtl:pl-2 ltr:pr-2 flex items-center"><!----><!----><!----><svg
                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                                class="inline-block w-4 h-4 text-gray-500 v-popper--has-tooltip">
            ...
            <div class="relationship-input hidden relationship-input-empty"><!----><!---->
                ...
                </div><!----><input type="hidden" name="entries" value="[]">
            </div><!----><!----><!---->
        </div>
    </div>
@endsection
