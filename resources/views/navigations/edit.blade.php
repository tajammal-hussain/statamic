            ...
            <div>
                <div>
                                        ...
                                        <div class="publish-fields @container">
                                            <div
                                                ...
                                                <div class="form-group publish-field publish-field__max_depth integer-fieldtype w-full"
                                                    ...
                                                    <div class="field-inner">
                                                        <label for="field_max_depth" class="publish-field-label">
                                                            <span
                                                                class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">{{ 'Max Depth' }}</span>
                                                            <button class="outline-none" style="display: none;">
                                                    ...
                                                    <div class="flex items-center">
                                                        <div class="input-group">
                                                            <input id="field_max_depth" name="max_depth" type="number"
                                                                value="{{ json_decode($navigation->settings)->max_depth }}"
                                                                class="input-text">
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="py-4 border-t flex justify-between">
                        <a href="{{ route('navigations.index') }}" class="btn">{{ 'Cancel' }}</a>
