        ...
        <div>
            ...
            <div>
                                    ...
                                    <div class="publish-fields @container">
                                        <div
                                            ...
                                            <div class="field-inner"><label for="field_collections"
                                                    ...
                                                    <span class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Collections</span>
                                            ...
                                            <div
                                                class="form-group publish-field publish-field__max_depth integer-fieldtype w-full" style="padding-left: 0rem !important; padding-right: 0rem !important;">
                                                ...
                                                <div class="flex items-center">
                                                    <div class="input-group">
                                                        <!----><input id="field_max_depth" name="max_depth"
                                                            type="number" value="" class="input-text">
                                                        <!---->
                                                    </div>
                                                    <!---->
                                                </div>
                ...
                <div class="py-4 border-t flex justify-between"><a href="https://demo.statamic.com/cp/navigation/footer"
                        class="btn">{{ 'Cancel' }}</a><button type="submit" class="btn-primary">{{ 'Save' }}</button>
                </div>
            </div>
    </form>
</div>
