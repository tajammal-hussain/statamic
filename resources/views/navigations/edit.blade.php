        ...
        <header class="mb-6">
            <div class="flex"><a href="https://demo.statamic.com/cp/navigation/footer"
                    ...
                    <div class="h-6 rotate-180 svg-icon using-svg"><svg viewBox="0 0 24 24" class="align-middle">
                        ...
                        </svg></div> <span>{{ $navigations->title }}</span>
                </a></div>
                                            ...
                                            <div
                                                ...
                                                <div class="field-inner"><label for="field_title"
                                                    ...
                                                    <div class="help-block -mt-2">
                                                        <p>We recommend a name that matches where it will be used, like
                                                            "Main
                                                            Nav" or "Footer
                                                            Nav".</p>
                                                    </div>
                                ...
                                <div class="publish-sections-section">
                                    <div class="p-0 card"><!---->
                                        <div class="publish-fields @container">
                                                        ...
                                                        <div data-v-c80a132c="" dir="auto"
                                                            ...
                                                            <div data-v-c80a132c=""
                                                                ...
                                                                tabindex="0"><span data-v-c80a132c=""
                                                                    class="vs__selected mt-2 sortable-item"
                                                                    tabindex="0">
                                                                    Pages <button data-v-c80a132c="" type="button"
                                                                        aria-label="Deselect option"
                                                                        class="vs__deselect"><span
                                                                            data-v-c80a132c="">×</span></button></span><span
                                                                    data-v-c80a132c=""
                                                                    class="vs__selected mt-2 sortable-item"
                                                                    tabindex="0"> News Articles <button
                                                                        data-v-c80a132c="" type="button"
                                                                        aria-label="Deselect option"
                                                                        class="vs__deselect"><span
                                                                            data-v-c80a132c="">×</span></button></span>
                                                            </div>
                                                        </div>
                                                    </div><!----><!---->
                                                </div><!----><!---->
                                            ...
                                            <div
                                                class="form-group publish-field publish-field__max_depth integer-fieldtype w-full">
                                                ...
                                                <div class="flex items-center">
                                                    <div class="input-group"><!----><input id="field_max_depth"
                                                            name="max_depth" type="number"
                                                            value="{{ json_decode($navigations->settings)->max_depth }}"
