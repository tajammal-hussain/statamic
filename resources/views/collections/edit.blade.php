                        ...
                        <div>
                            <div class="tabs-container flex items-center">
                                <div role="tablist" aria-label="Edit Content" class="publish-tabs tabs"><button role="tab"
                                                                                                                id="MainTab" aria-controls="MainTabPanel" tabindex="0" class="tab-button active"
                                                                                                                aria-selected="true">Main</button><button role="tab" id="MetaSeoTab"
                                                                                                                                                          aria-controls="MetaSeoTabPanel" tabindex="-1" class="tab-button">Meta/SEO</button><button
                                            role="tab" id="SEOTab" aria-controls="SEOTabPanel" tabindex="-1"
                                            class="tab-button">SEO</button></div><!----><!----><!---->
                            </div>
                            <div class="publish-tab-outer">
                                <div class="publish-tab-wrapper w-full min-w-0">
                                    <div data-tab-handle="main" tabindex="0" class="publish-tab tab-panel w-full" role="tabpanel"
                                         id="MainTabPanel" aria-labelledby="MainTab" style="">
                                    ...
                                    <div data-tab-handle="SEO" tabindex="0" class="publish-tab tab-panel w-full"
                                        ...
                                        <div class="publish-sections">
                                            <div class="publish-sections-section">
                                              ...
                                              Priority</span><!----><!----><!----><!----><button class="outline-none"
                                                                                                 style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                                                             viewBox="0 0 24 24"
                                                                                                                             class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                                                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                    ...
                                                    <div class="publish-fields @container">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="field-inner"><label for="field_parent" class="publish-field-label"><span
                                                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Parent</span><!----><!----><!----><!----><button
                                                                            class="outline-none" style="display: none;"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                                                class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                            ...
                                                            <div class="relationship-input"><!----><!---->
                                                                ...
                                                                </div><!----><!----><!----><input type="hidden" name="parent"
                                                                                                  value="[&quot;home&quot;]">
                                                            </div><!----><!---->
                                                        </div>
                                                    </div>
