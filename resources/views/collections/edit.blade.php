    ...
    <div class="page-wrapper max-w-xl">
          <div>
            ...
            <div>
                          ...
                          <div class="form-group publish-field publish-field__title text-fieldtype w-full">
                            ...
                            <div class="flex items-center">
                              <div class="input-group"><!----><input id="field_title" name="title" type="text"
                                  autofocus="autofocus" class="input-text" value="123"><!----></div><!---->
                            </div><!----><!---->
                          </div>
                        </div>
                      </div>
                ...
                <div>
                  <div class="publish-sections">
                    <div class="publish-sections-section">
                      <div class="p-0 card"><!---->
                        <div class="publish-fields @container">
                          <div class="form-group publish-field publish-field__dated toggle-fieldtype w-full">
                            <div class="field-inner"><label for="field_dated" class="publish-field-label"><span
                                  class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Enable Publish
                                  Dates</span><!----><!----><!----><!----><button class="outline-none"
                              ...
                              <div class="help-block -mt-2">
                                <p>Publish dates can be used to schedule and expire content.</p>
                              </div>
                            </div><!---->
                            <div class="toggle-fieldtype-wrapper"><button type="button" aria-pressed="false"
                                aria-label="Toggle Button" class="toggle-container" id="field_dated">
                          ...
                          <div
                            class="form-group publish-field publish-field__past_date_behavior select-fieldtype w-full"
                            style="display: none;">
                            <div class="field-inner"><label for="field_past_date_behavior"
                                class="publish-field-label"><span class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Past
                                  Date Behavior</span><!----><!----><!----><!----><button class="outline-none"
                                  style="display: none;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                                      stroke-linejoin="round" stroke-width="1.5"
                              ...
                              <div class="help-block -mt-2">
                                <p>How past dated entries should behave.</p>
                              </div>
                            </div><!---->
                            <div data-v-288ded3d="" class="flex">
                              <div data-v-288ded3d="" dir="auto" class="v-select flex-1 vs--single vs--searchable"
                                name="past_date_behavior">
                                <div id="vs1__combobox" role="combobox" aria-expanded="false" aria-owns="vs1__listbox"
                                  ...
                                  <div class="vs__selected-options"><span class="vs__selected">
                                      ...
                                      <!----></span> <input id="field_past_date_behavior" aria-autocomplete="list"
                          ...
                          <div
                            class="form-group publish-field publish-field__future_date_behavior select-fieldtype w-full"
                            style="display: none;">
                            <div class="field-inner"><label for="field_future_date_behavior"
                                class="publish-field-label"><span class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Future
                                  Date Behavior</span><!----><!----><!----><!----><button class="outline-none"
                                  style="display: none;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                              ...
                              <div class="help-block -mt-2">
                                <p>How future dated entries should behave.</p>
                              </div>
                            </div><!---->
                            <div data-v-288ded3d="" class="flex">
                              <div data-v-288ded3d="" dir="auto" class="v-select flex-1 vs--single vs--searchable"
                                name="future_date_behavior">
                                <div id="vs2__combobox" role="combobox" aria-expanded="false" aria-owns="vs2__listbox"
                                  aria-label="Search for option" class="vs__dropdown-toggle">
                                  <div class="vs__selected-options"><span class="vs__selected">
                                      Private - Hidden from listings, URLs 404
                                      <!----></span> <input id="field_future_date_behavior" aria-autocomplete="list"
                                      aria-labelledby="vs2__combobox" aria-controls="vs2__listbox" type="search"
                                      autocomplete="off" class="vs__search"></div>
                                  <div class="vs__actions"><button type="button" title="Clear Selected"
                                      aria-label="Clear Selected" class="vs__clear"
                                      style="display: none;"><span>×</span></button> <span
              ...
              <div>
                <div class="mb-2 content">
                  <h2 class="text-base">Ordering</h2>
                  <p></p>
                </div>
                <div>
                  <div class="publish-sections">
                    <div class="publish-sections-section">
                      <div class="p-0 card"><!---->
                        <div class="publish-fields @container">
                          <div class="form-group publish-field publish-field__structured toggle-fieldtype w-full">
                            <div class="field-inner"><label for="field_structured" class="publish-field-label"><span
                            ...
                            <div class="toggle-fieldtype-wrapper"><button type="button" aria-pressed="false"
                                aria-label="Toggle Button" class="toggle-container" id="field_structured">
                                <div class="toggle-slider">
                                  <div tabindex="0" class="toggle-knob"></div>
                                </div>
                              </button><!----></div><!----><!---->
                          ...
                          <div class="form-group publish-field publish-field__sort_direction select-fieldtype w-full">
                            <div class="field-inner"><label for="field_sort_direction" class="publish-field-label"><span
                            ...
                            <div data-v-288ded3d="" class="flex">
                              <div data-v-288ded3d="" dir="auto" class="v-select flex-1 vs--single vs--searchable"
                                ...
                                <div id="vs3__combobox" role="combobox" aria-expanded="false" aria-owns="vs3__listbox"
                                  ...
                                  <div class="vs__selected-options"><span class="vs__selected">
                                      Ascending
                                      <!----></span> <input id="field_sort_direction" aria-autocomplete="list"
                                      aria-labelledby="vs3__combobox" aria-controls="vs3__listbox" type="search"
                                      autocomplete="off" class="vs__search"></div>
                                  <div class="vs__actions"><button type="button" title="Clear Selected"
                                      aria-label="Clear Selected" class="vs__clear"
                                      style="display: none;"><span>×</span></button> <span
                          ...
                          <div class="form-group publish-field publish-field__expects_root toggle-fieldtype w-full"
                            style="display: none;">
                            <div class="field-inner"><label for="field_expects_root" class="publish-field-label"><span
                            ...
                            <div class="toggle-fieldtype-wrapper"><button type="button" aria-pressed="false"
                                aria-label="Toggle Button" class="toggle-container" id="field_expects_root">
                                <div class="toggle-slider">
                                  <div tabindex="0" class="toggle-knob"></div>
                                </div>
                              </button><!----></div><!----><!---->
                          ...
                          <div class="form-group publish-field publish-field__show_slugs toggle-fieldtype w-full"
                            style="display: none;">
                            <div class="field-inner"><label for="field_show_slugs" class="publish-field-label"><span
                            ...
                            <div class="toggle-fieldtype-wrapper"><button type="button" aria-pressed="false"
                                aria-label="Toggle Button" class="toggle-container" id="field_show_slugs">
                                <div class="toggle-slider">
                                  <div tabindex="0" class="toggle-knob"></div>
                                </div>
                              </button><!----></div><!----><!---->
                ...
                <div>
                  <div class="publish-sections">
                    <div class="publish-sections-section">
                      <div class="p-0 card"><!---->
                        <div class="publish-fields @container">
                          <div class="form-group publish-field publish-field__blueprints html-fieldtype w-full">
                            <div class="field-inner"><label for="field_blueprints" class="publish-field-label"><span
                            ...
                            <div>
                              <div class="text-xs"> <span class="rtl:ml-4 ltr:mr-4">123</span> <a
                                  href="http://127.0.0.1:8080/cp/collections/123/blueprints" class="text-blue">Edit</a>
                              </div>
                            </div><!----><!---->
                          </div>
                          <div class="form-group publish-field publish-field__links toggle-fieldtype w-full">
                            <div class="field-inner"><label for="field_links" class="publish-field-label"><span
                              ...
                              <div class="help-block -mt-2">
                                <p>Entries in this collection may contain links (redirects) to other entries or URLs.
                                </p>
                              </div>
                            </div><!---->
                            <div class="toggle-fieldtype-wrapper"><button type="button" aria-pressed="false"
                                aria-label="Toggle Button" class="toggle-container" id="field_links">
                                <div class="toggle-slider">
                                  <div tabindex="0" class="toggle-knob"></div>
                                </div>
                              </button><!----></div><!----><!---->
                          </div>
                          <div class="form-group publish-field publish-field__taxonomies relationship-fieldtype w-full">
                            <div class="field-inner"><label for="field_taxonomies" class="publish-field-label"><span
                              ...
                              <div class="help-block -mt-2">
                                <p>Connect entries in this collection to taxonomies. Fields will be automatically added
                                  to publish forms.</p>
                              </div>
                            </div><!---->
                            <div class="relationship-input relationship-input-empty">
                              <div data-v-c80a132c="">
                                <div data-v-c80a132c="" dir="auto" class="v-select vs--multiple vs--searchable">
                                  <div id="vs6__combobox" role="combobox" aria-expanded="false" aria-owns="vs6__listbox"
                                    aria-label="Search for option" class="vs__dropdown-toggle">
                                    <div class="vs__selected-options"> <input data-v-c80a132c="" placeholder="Choose..."
                                        type="search" aria-autocomplete="list" aria-labelledby="vs6__combobox"
                                        aria-controls="vs6__listbox" autocomplete="off" class="vs__search"></div>
                                    <div class="vs__actions"><button type="button" title="Clear Selected"
                                        aria-label="Clear Selected" class="vs__clear"
                                        style="display: none;"><span>×</span></button> <span
                                        class="toggle vs__open-indicator" role="presentation"><svg
                          ...
                          <div
                            ...
                            <div class="field-inner"><label for="field_default_publish_state"
                              ...
                              <div class="help-block -mt-2">
                                <p>While creating new entries in this collection the published toggle will default to
                                  <strong>true</strong> instead of <strong>false</strong> (draft).</p>
                              </div>
                            </div><!---->
                            <div class="toggle-fieldtype-wrapper"><button type="button" aria-pressed="true"
                                aria-label="Toggle Button" class="toggle-container on" id="field_default_publish_state">
                                <div class="toggle-slider">
                                  <div tabindex="0" class="toggle-knob"></div>
                                </div>
                              </button><!----></div><!----><!---->
                          </div>
                          <div class="form-group publish-field publish-field__template template-fieldtype w-full">
                            <div class="field-inner"><label for="field_template" class="publish-field-label"><span
                                  class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Template</span><!----><!----><!----><!----><button
                                  class="outline-none" style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                              ...
                              <div class="help-block -mt-2">
                                <p>Set this collection's default template. Entries can override this setting with a
                                  <code>template</code> field.</p>
                              </div>
                            </div><!---->
                            <div class="template-fieldtype-container">
                              <div dir="auto" class="v-select vs--single vs--searchable" name="template">
                                <div id="vs4__combobox" role="combobox" aria-expanded="false" aria-owns="vs4__listbox"
                                  ...
                                  <div class="vs__selected-options"><span class="vs__selected">
                                      default
                                      <!----></span> <input aria-autocomplete="list" aria-labelledby="vs4__combobox"
                                      aria-controls="vs4__listbox" type="search" autocomplete="off" class="vs__search">
                                  </div>
                                  <div class="vs__actions"><button type="button" title="Clear Selected"
                                      aria-label="Clear Selected" class="vs__clear"><span>×</span></button> <span
                                      class="toggle vs__open-indicator" role="presentation"><svg
                                        xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 20 20">
                                        <path fill="currentColor"
                                          d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z">
                          ...
                          <div class="form-group publish-field publish-field__layout template-fieldtype w-full">
                            <div class="field-inner"><label for="field_layout" class="publish-field-label"><span
                                  class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Layout</span><!----><!----><!----><!----><button
                                  class="outline-none" style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                              ...
                              <div class="help-block -mt-2">
                                <p>Set this collection's default layout. Entries can override this setting with a
                                  <code>template</code> field named <code>layout</code>. It is unusual to change this
                                  setting.</p>
                              </div>
                            </div><!---->
                            <div class="template-fieldtype-container">
                              <div dir="auto" class="v-select vs--single vs--searchable" name="layout">
                                <div id="vs5__combobox" role="combobox" aria-expanded="false" aria-owns="vs5__listbox"
                                  aria-label="Search for option" class="vs__dropdown-toggle">
                                  <div class="vs__selected-options"><span class="vs__selected">
                                      layout
                                      <!----></span> <input aria-autocomplete="list" aria-labelledby="vs5__combobox"
                                      aria-controls="vs5__listbox" type="search" autocomplete="off" class="vs__search">
                                  </div>
                                  <div class="vs__actions"><button type="button" title="Clear Selected"
                                      aria-label="Clear Selected" class="vs__clear"><span>×</span></button> <span
                                      class="toggle vs__open-indicator" role="presentation"><svg
                          ...
                          <div
                            ...
                            <div class="field-inner"><label for="field_title_formats" class="publish-field-label"><span
                              ...
                              <div class="help-block -mt-2">
                                <p>Set this to have the entries in this collection generate their titles automatically.
                                  Learn more in the <a target="_blank"
                                    href="https://statamic.dev/collections#titles">documentation</a>.</p>
                              </div>
                            </div><!---->
                            <div><!---->
                              <div>
                                <div class="flex items-center slug-field" dir="ltr">
                                  <div class="input-group"><!----><input type="text" class="input-text"><!----></div>
                                  <!---->
                                </div>
                              </div>
                            </div><!----><!---->
                      ...
                      <div class="p-0 card"><!---->
                        <div class="publish-fields @container">
                          <div
                            ...
                            <div class="field-inner"><label for="field_routes" class="publish-field-label"><span
                              ...
                              <div class="help-block -mt-2">
                                <p>The route controls entries URL pattern. Learn more in the <a target="_blank"
                                    href="https://statamic.dev/collections#routing">documentation</a>.</p>
                              </div>
                            </div><!---->
                            <div><!---->
                              <div>
                          ...
                          <div class="form-group publish-field publish-field__require_slugs toggle-fieldtype w-full">
                            <div class="field-inner"><label for="field_require_slugs" class="publish-field-label"><span
                            ...
                            <div class="toggle-fieldtype-wrapper"><button type="button" aria-pressed="true"
                                aria-label="Toggle Button" class="toggle-container on" id="field_require_slugs">
                                <div class="toggle-slider">
                                  <div tabindex="0" class="toggle-knob"></div>
                                </div>
                              </button><!----></div><!----><!---->
                          </div>
                          <div class="form-group publish-field publish-field__mount relationship-fieldtype w-full">
                            <div class="field-inner"><label for="field_mount" class="publish-field-label"><span
                                  class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Mount</span><!----><!----><!----><!----><button
                                  class="outline-none" style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                              ...
                              <div class="help-block -mt-2">
                                <p>Choose an entry on which this collection should be mounted. Learn more in the <a
                                    target="_blank"
                                    href="https://statamic.dev/collections-and-entries#mounting">documentation</a>.</p>
                              </div>
                            </div><!---->
                            <div class="relationship-input relationship-input-empty"><!----><!---->
                              ...
                              <div class="relationship-input-buttons relative @container">
                                <div class="flex flex-wrap items-center text-sm -mb-2">
                                  <div class="relative mb-2"><!----></div><button
                                    class="text-blue hover:text-gray-800 flex items-center mb-2 outline-none"><svg
                                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                              ...
                              </div><!----><input type="hidden" name="mount" value="[]">
                            </div><!----><!---->
                          </div>
                          <div class="form-group publish-field publish-field__preview_targets grid-fieldtype w-full">
                            <div class="field-inner"><label for="field_preview_targets"
                                class="publish-field-label"><span
                                  class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Preview
                                  Targets</span><!----><!----><!----><!----><button class="outline-none"
                                  style="display: none;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                                      stroke-linejoin="round" stroke-width="1.5"
                              ...
                              <div class="help-block -mt-2">
                                <p>The URLs to be viewable within Live Preview. Learn more in the <a target="_blank"
                                    href="https://statamic.dev/live-preview#preview-targets">documentation</a>.</p>
                              </div>
                            </div><!---->
                            <div>
                                  ...
                                  <table class="grid-table">
                                    <thead>
                                      <tr>
                                        ...
                                        <th>
                                          <div class="flex items-center justify-between">
                                            <div>Refresh</div><svg xmlns="http://www.w3.org/2000/svg"
                                              viewBox="0 0 10 10"
                                        ...
                                        <th class="grid-row-controls row-controls"><button
                                            class="flex items-center w-full h-full justify-center text-gray-500 hover:text-gray-700"><svg
                                              ...
                                              class="h-3.5 w-3.5" style="display: none;">
                                              <path fill="currentColor"
                                    ...
                                    <tbody tabindex="0">
                                      <tr data-v-7ddde4ab="" class="preview_targets-sortable-item" tabindex="0">
                                        <td data-v-7ddde4ab="" class="drag-handle preview_targets-drag-handle"></td>
                                        <td data-v-7ddde4ab="" class="grid-cell text-fieldtype">
                                          <div class="@container">
                                            <div class="flex items-center">
                                              <div class="input-group"><!----><input
                                                  id="preview_targets.0.label.field_label"
                                                  name="preview_targets[0][label]" type="text" class="input-text"
                                                  value="Entry"><!----></div><!---->
                                            </div>
                                          </div><!---->
                                        </td>
                                          ...
                                          <div class="@container">
                                            <div class="flex items-center">
                                              <div class="input-group"><!----><input
                                                  ...
                                                  name="preview_targets[0][format]" type="text" class="input-text"
                                                  value="{permalink}"><!----></div><!---->
                                            </div>
                                          </div><!---->
                                        </td>
                                        <td data-v-7ddde4ab="" class="grid-cell toggle-fieldtype">
                                          <div class="@container">
