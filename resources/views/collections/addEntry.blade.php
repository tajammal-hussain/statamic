                                                                        ...
                                                                        <div class=""><input type="file"
                                                                            ...
                                                                            <div>
                                                                                <div class="markdown-toolbar">
                                                                                    <div class="markdown-modes"><button
                                                                                            aria-pressed="true"
                                                                                            class="active">Write</button><button
                                                                                            aria-pressed="false"
                                                                                            class="">Preview</button>
                                                                                    </div>
                                                                                    <div class="markdown-buttons"><button
                                                                                            aria-label="Bold"
                                                                                    ...
                                                                                    <div class="markdown-writer">
                                                                                        <div class="editor">
                                                                                            <div class="CodeMirror cm-s-default CodeMirror-wrap"
                                                                                                ...
                                                                                                <div class="CodeMirror-vscrollbar"
                                                                                                    ...
                                                                                                    style="bottom: 0px;">
                                                                                                    <div
                                                                                                        style="min-width: 1px; height: 0px;">
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="CodeMirror-scroll"
                                                                                                    ...
                                                                                                    <div class="CodeMirror-gutters"
                                                                                                        style="display: none; height: 61px;">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="helpers">
                                                                                            <div class="flex w-full">
                                                                                                <div
                                                                                                    class="markdown-cheatsheet-helper">
                                                                                                    <button
