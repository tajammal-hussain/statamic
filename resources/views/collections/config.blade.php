...
<div class="page-wrapper max-w-xl">
    ...
    <div class="card p-4 content">
      <div class="flex flex-wrap">
        <a
          href="{{route('collections.edit',['collection' => $collection->handle])}}"
          ...
          <div class="flex-1 mb-4 md:mb-0 rtl:md:ml-6 ltr:md:mr-6">
            <h3 class="mb-2 text-blue">Configure Collection →</h3>
            <p>
              Configure URL and routes, define blueprints,
              data behaviours,ordering and other options.
            </p>
          </div></a
        >
        <a
          href="{{ route('entries.index', ['collection' => $collection->handle])}}"
          class="w-full lg:w-1/2 p-4 flex items-start hover:bg-gray-200 rounded-md group"
          ><div class="h-8 w-8 rtl:ml-4 ltr:mr-4 text-gray-800">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
          ...
          <div class="flex-1 mb-4 md:mb-0 rtl:md:ml-6 ltr:md:mr-6">
            <h3 class="mb-2 text-blue">Create Entry →</h3>
            <p>
              Create the first entry or stub out a handful of placeholder
              entries, it's up to you.
            </p>
          </div></a
        >
        <div
