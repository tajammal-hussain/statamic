...
@section('content')
    ...
    <div class="page-wrapper max-w-3xl" bis_skin_checked="1">
        <div published="true" bis_skin_checked="1">
          <div class="breadcrumb flex" bis_skin_checked="1"><a href="https://demo.statamic.com/cp/collections/news"
              ...
              </svg><span>News Articles</span></a></div>
          <div class="flex items-center mb-6" bis_skin_checked="1">
            <h1 class="flex-1">
              <div class="flex items-center" bis_skin_checked="1"><!----><span>Create Entry</span></div>
            </h1><!----><!---->
            <div class="hidden md:flex items-center" bis_skin_checked="1">
              <div class="btn-group" bis_skin_checked="1"><button class="btn-primary">Save &amp; Publish</button>
                <div class="dropdown-list rtl:text-right ltr:text-left" bis_skin_checked="1">
          ...
          <div bis_skin_checked="1">
            <div bis_skin_checked="1">
              <div bis_skin_checked="1">
                <div bis_skin_checked="1">
                  <div class="tabs-container flex items-center" bis_skin_checked="1">
                    <div role="tablist" aria-label="Edit Content" class="publish-tabs tabs" bis_skin_checked="1">
                      <button role="tab" id="MainTab" aria-controls="MainTabPanel" aria-selected="true" tabindex="0"
                        class="tab-button active">Main</button><button role="tab" id="SEOTab"
                        aria-controls="SEOTabPanel" tabindex="-1" class="tab-button">SEO</button></div>
                    <!----><!----><!---->
                  </div>
                  <div class="publish-tab-outer" bis_skin_checked="1">
                    <div class="publish-tab-wrapper w-full min-w-0" bis_skin_checked="1">
                      <div data-tab-handle="main" tabindex="0" class="publish-tab tab-panel w-full" role="tabpanel"
                        id="MainTabPanel" aria-labelledby="MainTab" bis_skin_checked="1">
                        <div class="publish-sections" bis_skin_checked="1">
                          <div class="publish-sections-section" bis_skin_checked="1">
                            <div class="p-0 card" bis_skin_checked="1"><!---->
                              <div class="publish-fields @container" bis_skin_checked="1">
                                <div class="form-group publish-field publish-field__title text-fieldtype w-full"
                                  bis_skin_checked="1">
                                  <div class="field-inner" bis_skin_checked="1"><label for="field_title"
                                  ...
                                  <div class="flex items-center" bis_skin_checked="1">
                                    <div class="input-group" bis_skin_checked="1"><!----><input id="field_title"
                                        name="title" type="text" autofocus="autofocus" class="input-text"
                                        data-listener-added_08c55641="true"><!----></div><!---->
                                  </div><!----><!---->
                                </div>
                                <div
                                  class="form-group publish-field publish-field__featured_image assets-fieldtype w-full"
                                  bis_skin_checked="1">
                                  <div class="field-inner" bis_skin_checked="1"><label for="field_featured_image"
                                      class="publish-field-label"><span
                                        class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Featured
                                        Image</span><!----><!----><!----><!----><button class="outline-none"
                                  ...
                                  <div class="@container" bis_skin_checked="1">
                                    <div bis_skin_checked="1">
                                      <div class="" bis_skin_checked="1"><input type="file" multiple="multiple"
                                          class="hidden">
                                        <div class="assets-fieldtype-drag-container" bis_skin_checked="1">
                                          <div class="drag-notification" style="display: none;" bis_skin_checked="1">
                                          ...
                                          <div class="assets-fieldtype-picker" bis_skin_checked="1"><button
                                              type="button" tabindex="0" class="btn btn-with-icon"><svg
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                ...
                                <div
                                  class="form-group publish-field publish-field__article_content bard-fieldtype w-full"
                                  bis_skin_checked="1">
                                  <div class="field-inner" bis_skin_checked="1"><label for="field_article_content"
                                      class="publish-field-label"><span
                                        class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Article
                                        Content</span><!----><!----><!----><!----><button class="outline-none"
                                        style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                          viewBox="0 0 24 24"
                                          class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                          <path fill="none" stroke="currentColor" stroke-linecap="round"
                                  ...
                                  <div bis_skin_checked="1">
                                    <div class="" bis_skin_checked="1">
                                      <div class="" bis_skin_checked="1">
                                        <div class="bard-fieldtype-wrapper" bis_skin_checked="1">
                                          <div class="bard-fixed-toolbar" bis_skin_checked="1">
                                            <div class="flex flex-wrap flex-1 items-center no-select"
                                              bis_skin_checked="1"><button aria-label="Heading 2"
                                                class="bard-toolbar-button v-popper--has-tooltip"><svg
                                                ...
                                                </svg><!----></button><button aria-label="Heading 3"
                                                class="bard-toolbar-button v-popper--has-tooltip"><svg
                                                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14">
                                                  <defs>
                                                    <clippath id="a">
                                                ...
                                                </svg><!----></button><button aria-label="Bold"
                                                class="bard-toolbar-button v-popper--has-tooltip"><svg
                                                ...
                                                </svg><!----></button><button aria-label="Remove Formatting"
                                                class="bard-toolbar-button v-popper--has-tooltip"><svg
                                                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                  <path fill="currentColor"
                                              ...
                                              <div class="" bis_skin_checked="1">
                                                ...
                                                </svg><!----></button><button aria-label="Show HTML Source"
                                                class="bard-toolbar-button v-popper--has-tooltip"><svg
                                                  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"
                                                  class="w-4 h-4">
                                                  <path fill="currentColor" fill-rule="evenodd"
                                                    ...
                                                    clip-rule="evenodd"></path>
                                                </svg></button><button aria-label="Expand/Collapse Sets"
                                                class="bard-toolbar-button v-popper--has-tooltip"><svg
                                                  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"
                                                  class="w-4 h-4">
                                                  <path fill="currentColor" fill-rule="evenodd"
                                                ...
                                                class="bard-toolbar-button v-popper--has-tooltip"><svg
                                                  ...
                                                  class="w-4 h-4" style="display: none;">
                                                  <path fill="currentColor"
                                                  ...
                                                  viewBox="0 0 14 14" class="w-4 h-4">
                                                  <path fill="currentColor" fill-rule="evenodd"
                                          ...
                                          <div tabindex="0" class="bard-editor @container/bard" bis_skin_checked="1">
                                            <!----><!----><!---->
                                            <div id="field_article_content" bis_skin_checked="1">
                                              <div contenteditable="true" translate="no" tabindex="0"
                                                class="ProseMirror bard-content" bis_skin_checked="1">
                                                <p><br class="ProseMirror-trailingBreak"></p>
                                              </div>
                                            </div><!---->
                                          </div>
                                          <div class="bard-footer-toolbar" bis_skin_checked="1">
                                            <div bis_skin_checked="1">00:00 Reading Time</div><!---->
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                ...
                                <div
                                  ...
                                  bis_skin_checked="1">
                                  <div class="field-inner" bis_skin_checked="1"><label for="field_author"
                                      class="publish-field-label"><span
                                        class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Author</span><!----><!----><!----><!----><button
                                        class="outline-none" style="display: none;"><svg
                                          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                          class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                          <path fill="none" stroke="currentColor" stroke-linecap="round"
                                  ...
                                  <div class="relationship-input relationship-input-empty" bis_skin_checked="1">
                                    <div data-v-c80a132c="" bis_skin_checked="1">
                                      <div data-v-c80a132c="" dir="auto" class="v-select vs--single vs--searchable"
                                        ...
                                        <div id="vs13__combobox" role="combobox" aria-expanded="false"
                                          ...
                                          class="vs__dropdown-toggle" bis_skin_checked="1">
                                          <div class="vs__selected-options" bis_skin_checked="1"> <input
                                              placeholder="Choose..." aria-autocomplete="list"
                                          ...
                                          <div class="vs__actions" bis_skin_checked="1"><button type="button"
                                              title="Clear Selected" aria-label="Clear Selected" class="vs__clear"
                                            ...
                                            <div class="vs__spinner" style="display: none;" bis_skin_checked="1">
                                              Loading...</div>
                                          </div>
                                        </div>
                            ...
                            <div class="p-0 card" bis_skin_checked="1"><!---->
                              <div class="publish-fields @container" bis_skin_checked="1">
                                <div class="form-group publish-field publish-field__seo seo_pro-fieldtype w-full"
                                  bis_skin_checked="1">
                                  <div class="field-inner" bis_skin_checked="1"><label for="field_seo"
                                      class="publish-field-label"><span
                                        class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">SEO</span><!----><!----><!----><!----><button
                                        class="outline-none" style="display: none;"><svg
                                          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                          class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                          <path fill="none" stroke="currentColor" stroke-linecap="round"
                                  ...
                                  <div class="publish-fields" bis_skin_checked="1">
                                    <div
                                      class="form-group form-group publish-field publish-field__enabled toggle-fieldtype w-full"
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label for="field_enabled"
                                          class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Enabled</span><!----><!----><!----><!----><button
                                            class="outline-none" style="display: none;"><svg
                                              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>Disabling this section will exclude it from reports and the sitemap, and
                                            prevent anything from being rendered through the template tag.</p>
                                        </div>
                                      </div><!---->
                                      <div class="toggle-fieldtype-wrapper" bis_skin_checked="1"><button type="button"
                                          aria-pressed="true" aria-label="Toggle Button" class="toggle-container on"
                                          id="field_enabled">
                                          <div class="toggle-slider" bis_skin_checked="1">
                                            <div tabindex="0" class="toggle-knob" bis_skin_checked="1"></div>
                                          </div>
                                        </button><!----></div><!----><!---->
                                    </div>
                                    <div
                                      ...
                                      <div class="field-inner" bis_skin_checked="1"><label for="field_title"
                                          class="publish-field-label"><span
                                            ...
                                            Title</span><!----><!----><!----><!----><button class="outline-none"
                                            style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                              viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>Pick an existing field to set as this section's <strong>default</strong>
                                            meta title.</p>
                                        </div>
                                      </div><!---->
                                      <div class="flex" bis_skin_checked="1">
                                        <div class="source-type-select pr-4" bis_skin_checked="1">
                                          <div dir="auto" class="v-select vs--single vs--searchable"
                                            ...
                                            <div id="vs1__combobox" role="combobox" aria-expanded="false"
                                              ...
                                              <div class="vs__selected-options" bis_skin_checked="1"><span
                                                  ...
                                                  aria-labelledby="vs1__combobox" aria-controls="vs1__listbox"
                                                  type="search" autocomplete="off" class="vs__search"></div>
                                              <div class="vs__actions" bis_skin_checked="1"><button type="button"
                                                  title="Clear Selected" aria-label="Clear Selected" class="vs__clear"
                                                  style="display: none;"><span>×</span></button> <span
                                    ...
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label for="field_description"
                                          class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Meta
                                            Description</span><!----><!----><!----><!----><button class="outline-none"
                                            style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                              viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                    ...
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label for="field_site_name"
                                          class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Site
                                            Name</span><!----><!----><!----><!----><button class="outline-none"
                                            style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                              viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>Optionally disable the site name for this section.</p>
                                        </div>
                                      </div><!---->
                                      <div class="flex" bis_skin_checked="1">
                                        <div class="source-type-select pr-4" bis_skin_checked="1">
                                        ...
                                        <div class="flex-1" bis_skin_checked="1">
                                          <div class="text-sm text-grey inherit-placeholder mt-1"
                                            bis_skin_checked="1"> Site Name </div>
                                        </div>
                                      </div><!----><!---->
                                    </div>
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label
                                          for="field_site_name_position" class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Site Name
                                            Position</span><!----><!----><!----><!----><button class="outline-none"
                                            style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                              viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>Optionally adjust the position for this section.</p>
                                        </div>
                                      </div><!---->
                                      <div class="flex" bis_skin_checked="1">
                                        <div class="source-type-select pr-4" bis_skin_checked="1">
                                    ...
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label
                                          for="field_site_name_separator" class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Site Name
                                            Separator</span><!----><!----><!----><!----><button class="outline-none"
                                            style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                              viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>Optionally adjust the separator for this section.</p>
                                        </div>
                                      </div><!---->
                                      <div class="flex" bis_skin_checked="1">
                                        <div class="source-type-select pr-4" bis_skin_checked="1">
                                    ...
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label for="field_canonical_url"
                                          class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Canonical
                                            URL</span><!----><!----><!----><!----><button class="outline-none"
                                            style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                              viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                    ...
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label for="field_robots"
                                          class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Robots</span><!----><!----><!----><!----><button
                                            class="outline-none" style="display: none;"><svg
                                              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>Pick options for the robots meta tag. noindex prevents the page being
                                            indexed by search engines. nofollow prevents search engines from crawling
                                            links.</p>
                                        </div>
                                      </div><!---->
                                      <div class="flex" bis_skin_checked="1">
                                    ...
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label for="field_image"
                                          class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Image</span><!----><!----><!----><!----><button
                                            class="outline-none" style="display: none;"><svg
                                              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>Choose a default image field to represent each URL in this section when
                                            shared on social networks.</p>
                                        </div>
                                      </div><!---->
                                      <div class="flex" bis_skin_checked="1">
                                        <div class="source-type-select pr-4" bis_skin_checked="1">
                                    ...
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label for="field_twitter_handle"
                                          class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Twitter
                                            Handle</span><!----><!----><!----><!----><button class="outline-none"
                                            style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                              viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>Choose a default twitter handle that corresponds to this section.</p>
                                        </div>
                                      </div><!---->
                                      <div class="flex" bis_skin_checked="1">
                                        <div class="source-type-select pr-4" bis_skin_checked="1">
                                    ...
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label for="field_sitemap"
                                          class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Sitemap</span><!----><!----><!----><!----><button
                                            class="outline-none" style="display: none;"><svg
                                              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>If disabled, items in this section will not appear in the sitemap.</p>
                                        </div>
                                      </div><!---->
                                      <div class="flex" bis_skin_checked="1">
                                        <div class="source-type-select pr-4" bis_skin_checked="1">
                                    ...
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label for="field_priority"
                                          class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Priority</span><!----><!----><!----><!----><button
                                            class="outline-none" style="display: none;"><svg
                                              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>The priority of these URLs relative to other URLs on your site. Valid
                                    ...
                                    <div
                                      ...
                                      bis_skin_checked="1">
                                      <div class="field-inner" bis_skin_checked="1"><label
                                          for="field_change_frequency" class="publish-field-label"><span
                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Change
                                            Frequency</span><!----><!----><!----><!----><button class="outline-none"
                                            style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                                              viewBox="0 0 24 24"
                                              class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                              <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <div class="help-block -mt-2" bis_skin_checked="1">
                                          <p>A hint to search engines on how frequently the pages in this section are
                                            likely to change.</p>
                                        </div>
                                      </div><!---->
                                      <div class="flex" bis_skin_checked="1">
                                        ...
                                        <div class="flex-1" bis_skin_checked="1">
                                          <div class="text-sm text-grey inherit-placeholder mt-1"
                                            bis_skin_checked="1"> monthly </div>
                                        </div>
                                      </div><!----><!---->
                                    </div>
                                  </div><!----><!---->
                    ...
                    <div class="publish-sidebar" bis_skin_checked="1">
                      <div class="publish-tab" bis_skin_checked="1">
                        <div class="publish-tab-actions as-sidebar" bis_skin_checked="1">
                          <div bis_skin_checked="1">
                            <div class="card p-0 mb-5" bis_skin_checked="1">
                              <div class="" bis_skin_checked="1"><!----></div>
                              <div class="flex items-center justify-between px-4 py-2" bis_skin_checked="1"><label
                            ...
                            <div class="p-0 card" bis_skin_checked="1"><!---->
                              <div class="publish-fields @container" bis_skin_checked="1">
                                <div class="form-group publish-field publish-field__slug slug-fieldtype w-full"
                                  bis_skin_checked="1">
                                  <div class="field-inner" bis_skin_checked="1"><label for="field_slug"
                                      class="publish-field-label"><span
                                        class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Slug</span><!----><!----><!----><!----><button
                                        class="outline-none" style="display: none;"><svg
                                          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                          class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                          <path fill="none" stroke="currentColor" stroke-linecap="round"
                                  ...
                                  <div bis_skin_checked="1">
                                    <div class="flex items-center" bis_skin_checked="1">
                                      <div class="input-group" bis_skin_checked="1"><!----><input id="field_slug"
                                          type="text" dir="ltr" class="input-text font-mono text-xs"><!----></div>
                                      <!---->
                                    </div>
                                  </div><!----><!---->
                                </div>
                                <div class="form-group publish-field publish-field__date date-fieldtype w-full"
                                  bis_skin_checked="1">
                                  <div class="field-inner" bis_skin_checked="1"><label for="field_date"
                                      class="publish-field-label"><span
                                        class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Date</span><i
                                        class="required rtl:ml-1 ltr:mr-1">*</i><!----><!----><!----><button
                                        class="outline-none" style="display: none;"><svg
                                          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                          class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                  ...
                                  <div class="datetime min-w-[145px]" bis_skin_checked="1"><!---->
                                      ...
                                      <div class="flex-1" bis_skin_checked="1">
                                        <div bis_skin_checked="1">
                                          <div
                                            ...
                                            class="vc-container vc-blue vc-is-expanded" columns="1" rows="1"
                                            isexpanded="true" style="display: none;" bis_skin_checked="1">
                                            <div data-v-39b30300="" class="vc-popover-content-wrapper"
                                              bis_skin_checked="1"><!----></div>
                                            <div class="vc-pane-container" bis_skin_checked="1">
                                              <div data-v-5be4b00c="" class="vc-pane-layout"
                                                style="grid-template-columns: repeat(1, 1fr);" bis_skin_checked="1">
                                                <div data-v-74ad501d=""
                                                  class="vc-pane row-from-end-1 column-from-end-1"
                                                  bis_skin_checked="1">
                                                  <div data-v-74ad501d="" class="vc-header align-center"
                                                    bis_skin_checked="1">
                                                    <div data-v-74ad501d="" class="vc-title" bis_skin_checked="1">
                                                      April 2024</div>
                                                  </div>
                                                  <div data-v-74ad501d="" class="vc-weeks" bis_skin_checked="1">
                                                    <div data-v-74ad501d="" class="vc-weekday" bis_skin_checked="1">S
                                                    </div>
                                                    <div data-v-74ad501d="" class="vc-weekday" bis_skin_checked="1">M
                                                    </div>
                                                    <div data-v-74ad501d="" class="vc-weekday" bis_skin_checked="1">T
                                                    </div>
                                                    <div data-v-74ad501d="" class="vc-weekday" bis_skin_checked="1">W
                                                    </div>
                                                    <div data-v-74ad501d="" class="vc-weekday" bis_skin_checked="1">T
                                                    </div>
                                                    <div data-v-74ad501d="" class="vc-weekday" bis_skin_checked="1">F
                                                    </div>
                                                    <div data-v-74ad501d="" class="vc-weekday" bis_skin_checked="1">S
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Sunday, March 31, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">31</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Monday, April 1, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">1</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Tuesday, April 2, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">2</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Wednesday, April 3, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">3</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Thursday, April 4, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">4</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Friday, April 5, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">5</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Saturday, April 6, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">6</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Sunday, April 7, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">7</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Monday, April 8, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">8</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Tuesday, April 9, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">9</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Wednesday, April 10, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">10</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Thursday, April 11, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">11</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Friday, April 12, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">12</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Saturday, April 13, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">13</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Sunday, April 14, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">14</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Monday, April 15, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">15</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Tuesday, April 16, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">16</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Wednesday, April 17, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">17</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Thursday, April 18, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">18</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Friday, April 19, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">19</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Saturday, April 20, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">20</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Sunday, April 21, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">21</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Monday, April 22, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">22</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Tuesday, April 23, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">23</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Wednesday, April 24, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">24</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Thursday, April 25, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">25</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Friday, April 26, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">26</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Saturday, April 27, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">27</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Sunday, April 28, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">28</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1">
                                                      <div data-v-4420d078="" class="vc-highlights vc-day-layer"
                                                        bis_skin_checked="1">
                                                        <div data-v-4420d078=""
                                                      ...
                                                      </div><span data-v-4420d078="" tabindex="0"
                                                        aria-label="Monday, April 29, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable"
                                                        style="font-weight: var(--font-bold); color: var(--white);">29</span>
                                                      <div data-v-4420d078=""
                                                        class="vc-day-layer vc-day-box-center-bottom"
                                                        bis_skin_checked="1">
                                                        <div data-v-4420d078="" class="vc-dots" bis_skin_checked="1">
                                                          <span data-v-4420d078="" class="vc-dot"
                                                            style="background-color: var(--blue-600);"></span></div>
                                                      </div>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078="" tabindex="-1"
                                                        aria-label="Tuesday, April 30, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">30</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Wednesday, May 1, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">1</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Thursday, May 2, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">2</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Friday, May 3, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">3</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Saturday, May 4, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">4</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Sunday, May 5, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">5</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Monday, May 6, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">6</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Tuesday, May 7, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">7</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Wednesday, May 8, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">8</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Thursday, May 9, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">9</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Friday, May 10, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">10</span>
                                                    </div>
                                                    <div data-v-4420d078="" data-v-74ad501d=""
                                                      ...
                                                      bis_skin_checked="1"><span data-v-4420d078=""
                                                        aria-label="Saturday, May 11, 2024" aria-disabled="false"
                                                        role="button" class="vc-day-content vc-focusable">11</span>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                              <div class="vc-arrows-container title-center" bis_skin_checked="1">
                                                <div role="button" class="vc-arrow is-left" bis_skin_checked="1"><svg
                                                    data-v-63f7b5ec="" width="26px" height="26px" viewBox="0 -1 16 34"
                                                    class="vc-svg-icon">
                                                ...
                                                <div role="button" class="vc-arrow is-right" bis_skin_checked="1"><svg
                                                    data-v-63f7b5ec="" width="26px" height="26px"
                                        ...
                                        <div class="" bis_skin_checked="1">
                                          <div aria-haspopup="true" bis_skin_checked="1">
                                            <div class="input-group" bis_skin_checked="1">
                                              <div class="input-group-prepend flex items-center" bis_skin_checked="1">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                  class="w-4 h-4">
                                                  <rect width="22" height="20" x=".5" y="3.501" fill="none"
                                              ...
                                              <div
                                                class="input-text border border-gray-500 rtl:border-r-0 ltr:border-l-0 flex items-center rtl:pl-0 ltr:pr-0"
                                                bis_skin_checked="1"><input
                                                  class="input-text-minimal p-0 bg-transparent leading-none"><button
                                                  type="button" title="Clear" aria-label="Clear"
                                                  class="cursor-pointer px-2 hover:text-blue-500"><span>×</span></button>
                                              </div>
                                            </div>
                                          </div>
                                          <div class="v-portal" style="display: none;" bis_skin_checked="1"></div>
                                ...
                                <div
                                  class="form-group publish-field publish-field__tags relationship-fieldtype w-full"
                                  bis_skin_checked="1">
                                  <div class="field-inner" bis_skin_checked="1"><label for="field_tags"
                                      class="publish-field-label"><span
                                        class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Tags</span><!----><!----><!----><!----><button
                                        class="outline-none" style="display: none;"><svg
                                          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                          class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                          <path fill="none" stroke="currentColor" stroke-linecap="round"
                                    ...
                                    <div data-v-c80a132c="" bis_skin_checked="1">
                                      <div data-v-c80a132c="" dir="auto" class="v-select vs--multiple vs--searchable"
                                        ...
                                        <div id="vs14__combobox" role="combobox" aria-expanded="false"
                                          ...
                                          class="vs__dropdown-toggle" bis_skin_checked="1">
                                          <div class="vs__selected-options" bis_skin_checked="1"> <input
                                              data-v-c80a132c="" placeholder="Choose..." type="search"
                                              aria-autocomplete="list" aria-labelledby="vs14__combobox"
                                              aria-controls="vs14__listbox" autocomplete="off" class="vs__search">
                                          </div>
                                          <div class="vs__actions" bis_skin_checked="1"><button type="button"
                                              title="Clear Selected" aria-label="Clear Selected" class="vs__clear"
                                              style="display: none;"><span>×</span></button> <span
                                        ...
                                        <div data-v-c80a132c="" class="vs__selected-options-outside flex flex-wrap"
                                          tabindex="0" bis_skin_checked="1"></div>
                                      </div>
                                    </div><!----><!---->
                                  </div><!----><!---->
                                </div>
                  ...
                  <div class="publish-tab publish-tab-actions-footer vue-portal-target " bis_skin_checked="1"></div>
                </div>
              </div>
            </div><!---->
          </div>
          <div class="md:hidden mt-6 flex items-center" bis_skin_checked="1"><button
              class="btn-lg btn-primary w-full">Save</button><!----></div><!----><!----><!---->
        </div>
      </div>
@endsection
