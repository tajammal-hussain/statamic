                        ...
                        <div>
                            <div class="tabs-container flex items-center">
                                <div role="tablist" aria-label="Edit Content" class="publish-tabs tabs">
                                    <button role="tab" id="MainTab" aria-controls="MainTabPanel" tabindex="0" class="tab-button active" aria-selected="true">Main</button><button role="tab" id="MetaSeoTab" aria-controls="MetaSeoTabPanel" tabindex="-1" class="tab-button">Meta/SEO</button>
                                    <button role="tab" id="SEOTab" aria-controls="SEOTabPanel" tabindex="-1" class="tab-button">SEO</button></div>
                            </div>
