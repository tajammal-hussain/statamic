...
@section('content')
    <div class="page-wrapper max-w-3xl">
        <div>
            <form id="myForm" method="POST" action="{{ route('taxonomies.createTerm', ['handle' => $taxonomy->handle]) }}">
                @csrf
                <div class="breadcrumb flex"><a href="{{ route('taxonomies.table', ['handle' => $taxonomy->handle]) }}"
                ...
                <div class="flex items-center mb-6">
                    <h1 class="flex-1">
                        <div class="flex items-center"><span
                                class="little-dot rtl:ml-2 ltr:mr-2 published v-popper--has-tooltip"></span><span>{{ 'Create Term' }}</span>
                        </div>
                    </h1>
    ...
    <script>
        const submitFormUrl = "{{ route('taxonomies.createTerm', ['handle' => $taxonomy->handle]) }}";
    </script>
