        ...
        <div class="max-w-lg mt-4 mx-auto">
            <div class="rounded p-6 lg:px-20 lg:py-10 shadow bg-white">
                <header class="text-center mb-16">
                    ...
                    <p class="text-gray">A taxonomy is a system of classifying data around a set of unique
                        characteristics,
                ...
                <form action="{{ route('taxonomies.add') }}" method="POST">
                    ...
                    <div class="mb-10"><label for="name" class="font-bold text-base mb-1">Title</label><input
                                ...
                                id="title" name="title">
                        <div class="text-2xs text-gray-600 mt-2 flex items-center"> We recommend using a plural noun,
                            like
                            "Categories" or "Tags".
                        </div>
                    </div>
                    <div class="mb-4"><label for="name" class="font-bold text-base mb-1">Handle</label><input
                        ...
                        <div class="text-2xs text-gray-600 mt-2 flex items-center"> Used to reference this taxonomy on
                            the
            ...
            <div class="flex justify-center mt-8">
                <button tabindex="4"
                        class="btn-primary mx-auto btn-lg"> Create Taxonomy
                </button>
            </div>
        </div>
    </div>
