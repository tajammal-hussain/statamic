...
@section('content')
    ...
    <div class="page-wrapper max-w-full">
        <header class="mb-6">
            <div class="flex"><a href="{{ route('taxonomies.taxonomies') }}"
                            ...
                            <tr>
                                <th class="checkbox-column"><label for="checkerOfAllBoxes"
                                        class="flex items-center justify-center relative cursor-pointer"><input
                                            type="checkbox" id="checkerOfAllBoxes" class="relative top-0"></label></th>
                                ...
                                <th class="group sortable-column"><span>Slug</span><svg height="8" width="8"
                                        viewBox="0 0 10 6.5"
                        ...
                        <tbody tabindex="0">
                            @foreach ($taxonomyTerms as $data)
                                <tr class="sortable-row outline-none" tabindex="0"><!---    ->
                                    <th class="checkbox-column"><input type="checkbox" id="checkbox-tags::boat"
                                            value="tags::boat">
                                    </th>
                                    <td class="">
                                        <div class="flex items-center"><a
                                                href="{{ route('taxonomies.editTerm', ['handle' => $data->id]) }}">{{ json_decode($data->data)->title }}</a>
                                        </div>
                                    </td>
                                    <td class=""><span class="font-mono text-2xs">{{ $data->slug }}</span></td>
                                    <!---->
