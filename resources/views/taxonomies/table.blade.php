...
@section('content')
    <title>Taxonomies Tags :: Cedar</title>
    <div class="page-wrapper max-w-full">
        <header class="mb-6">
            <div class="flex"><a href="https://demo.statamic.com/cp/taxonomies"
                    ...
                    <div class="h-6 rotate-180 svg-icon using-svg"><svg viewBox="0 0 24 24" class="align-middle">
                        ...
                        </svg></div> <span>Taxonomies</span>
                </a></div>
            <div class="flex items-center">
                <h1 class="flex-1">Tags</h1>
                ...
                <div class="dropdown-list inline-block">
                    <div aria-haspopup="true"><button class="btn-primary flex items-center"><span>Create
                      Term</span><!----></button></div>
                    <div class="v-portal" style="display: none;"></div>
                </div>
            </div>
        </header>
            ...
            <div>
                <div class="card overflow-hidden p-0 relative">
                    <div class="flex flex-wrap items-center justify-between px-2 pb-2 text-sm border-b">
                        <div class="pt-2 rtl:pl-2 ltr:pr-2">
                            <div class="flex flex-wrap items-center"><button
                                        class="pill-tab rtl:ml-1 ltr:mr-1 active">All</button><button
                                        class="pill-tab v-popper--has-tooltip"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                                    viewBox="0 0 14 14" class="w-3 h-3">
                        ...
                        <div class="flex space-x-2 mt-2"><button class="btn btn-sm rtl:mr-2 ltr:ml-2"
                    ...
                    <table data-size="sm" tabindex="0" class="data-table" allow-column-picker="true"
                        ...
                        <tr>
                            ...
                            <th class="group current-column sortable-column"><span>Title</span><svg height="8" width="8"
                                                                                                    viewBox="0 0 10 6.5"
                            ...
                            <th class="group sortable-column"><span>Slug</span><svg height="8" width="8" viewBox="0 0 10 6.5"
                        ...
                        <tr class="sortable-row outline-none" tabindex="0"><!---->
                            <th class="checkbox-column"><input type="checkbox" id="checkbox-tags::boat" value="tags::boat">
                            </th>
                            <td class="">
                                <div class="flex items-center"><a
                                            href="https://demo.statamic.com/cp/taxonomies/tags/terms/boat/default">Boat</a></div>
                            </td>
                            <td class=""><span class="font-mono text-2xs">boat</span></td><!---->
                        ...
                        <tr class="sortable-row outline-none" tabindex="0"><!---->
                            <th class="checkbox-column"><input type="checkbox" id="checkbox-tags::cool" value="tags::cool">
                            </th>
                            <td class="">
                                <div class="flex items-center"><a
                                            href="https://demo.statamic.com/cp/taxonomies/tags/terms/cool/default">cool</a></div>
                            </td>
                            <td class=""><span class="font-mono text-2xs">cool</span></td><!---->
                            <th class="actions-column">
                                <div class="dropdown-list">
                                    <div aria-haspopup="true"><button aria-label="Open Dropdown" class="rotating-dots-button"><svg
                                                    width="12" viewBox="0 0 24 24" class="rotating-dots fill-current">
                        ...
                        <tr class="sortable-row outline-none" tabindex="0"><!---->
                            <th class="checkbox-column"><input type="checkbox" id="checkbox-tags::ftl" value="tags::ftl"></th>
                            <td class="">
                                <div class="flex items-center"><a
                                            href="https://demo.statamic.com/cp/taxonomies/tags/terms/ftl/default">FTL</a></div>
                            </td>
                            <td class=""><span class="font-mono text-2xs">ftl</span></td><!---->
                            <th class="actions-column">
                                <div class="dropdown-list">
                                    <div aria-haspopup="true"><button aria-label="Open Dropdown" class="rotating-dots-button"><svg
                                                    width="12" viewBox="0 0 24 24" class="rotating-dots fill-current">
                        ...
                        <tr class="sortable-row outline-none" tabindex="0"><!---->
                            <th class="checkbox-column"><input type="checkbox" id="checkbox-tags::incident"
                                                               value="tags::incident"></th>
                            <td class="">
                                <div class="flex items-center"><a
                                            href="https://demo.statamic.com/cp/taxonomies/tags/terms/incident/default">incident</a>
                                </div>
                            </td>
                            <td class=""><span class="font-mono text-2xs">incident</span></td><!---->
                            <th class="actions-column">
                                <div class="dropdown-list">
                                    <div aria-haspopup="true"><button aria-label="Open Dropdown" class="rotating-dots-button"><svg
                                                    width="12" viewBox="0 0 24 24" class="rotating-dots fill-current">
                        ...
                        <tr class="sortable-row outline-none" tabindex="0"><!---->
                            <th class="checkbox-column"><input type="checkbox" id="checkbox-tags::juice" value="tags::juice">
                            </th>
                            <td class="">
                                <div class="flex items-center"><a
                                            href="https://demo.statamic.com/cp/taxonomies/tags/terms/juice/default">juice</a></div>
                            </td>
                            <td class=""><span class="font-mono text-2xs">juice</span></td><!---->
                            <th class="actions-column">
                                <div class="dropdown-list">
                                    <div aria-haspopup="true"><button aria-label="Open Dropdown" class="rotating-dots-button"><svg
                                                    width="12" viewBox="0 0 24 24" class="rotating-dots fill-current">
                        ...
                        <tr class="sortable-row outline-none" tabindex="0"><!---->
                            <th class="checkbox-column"><input type="checkbox" id="checkbox-tags::power" value="tags::power">
                            </th>
                            <td class="">
                                <div class="flex items-center"><a
                                            href="https://demo.statamic.com/cp/taxonomies/tags/terms/power/default">Power</a></div>
                            </td>
                            <td class=""><span class="font-mono text-2xs">power</span></td><!---->
                            <th class="actions-column">
                                <div class="dropdown-list">
                                    <div aria-haspopup="true"><button aria-label="Open Dropdown" class="rotating-dots-button"><svg
                                                    width="12" viewBox="0 0 24 24" class="rotating-dots fill-current">
                        ...
                        <tr class="sortable-row outline-none" tabindex="0"><!---->
                            <th class="checkbox-column"><input type="checkbox" id="checkbox-tags::team" value="tags::team">
                            </th>
                            <td class="">
                                <div class="flex items-center"><a
                                            href="https://demo.statamic.com/cp/taxonomies/tags/terms/team/default">Team</a></div>
                            </td>
                            <td class=""><span class="font-mono text-2xs">team</span></td><!---->
                            <th class="actions-column">
                                <div class="dropdown-list">
                                    <div aria-haspopup="true"><button aria-label="Open Dropdown" class="rotating-dots-button"><svg
                                                    width="12" viewBox="0 0 24 24" class="rotating-dots fill-current">
                        ...
                        <tr class="sortable-row outline-none" tabindex="0"><!---->
                            <th class="checkbox-column"><input type="checkbox" id="checkbox-tags::technology"
                                                               value="tags::technology"></th>
                            <td class="">
                                <div class="flex items-center"><a
                                            href="https://demo.statamic.com/cp/taxonomies/tags/terms/technology/default">Technology</a>
                                </div>
                            </td>
                            <td class=""><span class="font-mono text-2xs">technology</span></td><!---->
                            <th class="actions-column">
                                <div class="dropdown-list">
                                    <div aria-haspopup="true"><button aria-label="Open Dropdown" class="rotating-dots-button"><svg
                                                    width="12" viewBox="0 0 24 24" class="rotating-dots fill-current">
                ...
                <div class="w-full flex mt-6">
                    <div class="flex flex-1 items-center">
                        <div class="text-xs text-gray-700"> 1-8 of 8 </div>
                    </div><!---->
