...
@section('content')
                                                                ...
                                                                <div class="flex items-center">
                                                                    <div class="input-group">
                                                                        <input id="field_title" name="title"
                                                                            ...
                                                                            class="input-text"
                                                                            value="{{ json_decode($taxonomyTerms->data)->title }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div>
                                                                    <textarea name="content" id="editor">{{ json_decode($taxonomyTerms->data)->content }}</textarea>
                                                                </div><!----><!---->
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    @php
        $metaData = json_decode($taxonomyTerms->data)->metaData ?? false;
    @endphp
    <script>
        const submitFormUrl = "{{ route('taxonomies.editTerm', ['id' => $taxonomyTerms->id]) }}";
