    ...
    <div class="page-wrapper max-w-xl">
        <div>
            ...
            <div>
                                        ...
                                        <div class="form-group publish-field publish-field__title text-fieldtype w-full">
                                            ...
                                            <div class="flex items-center">
                                                <div class="input-group"><!----><input id="field_title" name="title" type="text"
                                                                                       autofocus="autofocus" class="input-text" value="Tags"><!----></div><!---->
                                            </div><!----><!---->
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group publish-field publish-field__blueprints html-fieldtype w-full">
                                            <div class="field-inner"><label for="field_blueprints" class="publish-field-label"><span
                                                ...
                                                <div class="help-block -mt-2">
                                                    <p>Terms in this taxonomy may use any of these blueprints.</p>
                                                </div>
                                            </div><!---->
                                            <div>
                                                <div class="text-xs"> <span class="rtl:ml-4 ltr:mr-4">Tag</span> <a
                                                            href="https://demo.statamic.com/cp/taxonomies/tags/blueprints"
                                                ...
                                                <div data-v-c80a132c="">
                                                    <div data-v-c80a132c="" dir="auto" class="v-select vs--multiple vs--searchable">
                                                        <div id="vs4__combobox" role="combobox" aria-expanded="false" aria-owns="vs4__listbox"
                                                            ...
                                                            <div class="vs__selected-options"><i data-v-c80a132c="" class="hidden"></i> <input
                                                                        data-v-c80a132c="" placeholder="Choose..." type="search"
                                                                        aria-autocomplete="list" aria-labelledby="vs4__combobox"
                                                                        aria-controls="vs4__listbox" autocomplete="off" class="vs__search"></div>
                                                ...
                                                d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z">
                                                        ...
                                                        <div data-v-c80a132c="" class="vs__selected-options-outside flex flex-wrap"
                                                             tabindex="0"><span data-v-c80a132c="" class="vs__selected mt-2 sortable-item"
                                                                                tabindex="0"> News Articles <button data-v-c80a132c="" type="button"
                                                ...
                                                <div class="grid-fieldtype-container"><!---->
                                                    <section class=""><!---->
                                                        <table class="grid-table">
                                                            ...
                                                            <tbody tabindex="0">
                                                            <tr data-v-b63d425a="" class="preview_targets-sortable-item" tabindex="0">
                                                                <td data-v-b63d425a="" class="drag-handle preview_targets-drag-handle"></td>
                                                                <td data-v-b63d425a="" class="grid-cell text-fieldtype">
                                                                    <div class="@container">
                                                                        <div class="flex items-center">
                                                                ...
                                                                <td data-v-b63d425a="" class="grid-cell toggle-fieldtype">
                                                                    <div class="@container">
                                                                ...
                                                                <td data-v-b63d425a="" class="row-controls">
                                                                    <div data-v-b63d425a="" class="dropdown-list">
                ...
                <div>
                    <div class="mb-2 content">
                        <h2 class="text-base">Templates</h2>
                        <p></p>
                    </div>
                    <div>
                        <div class="publish-sections">
                                    ...
                                    <div class="publish-fields @container">
                                        <div class="form-group publish-field publish-field__template template-fieldtype w-full">
                                            <div class="field-inner"><label for="field_template" class="publish-field-label"><span
                                                ...
                                                <div class="help-block -mt-2">
                                                    <p>Set this taxonomy's default template.</p>
                                                </div>
                                            </div><!---->
                                            <div class="template-fieldtype-container">
                                                <div dir="auto" class="v-select vs--single vs--searchable" name="template">
                                                    <div id="vs1__combobox" role="combobox" aria-expanded="false" aria-owns="vs1__listbox"
                                                         aria-label="Search for option" class="vs__dropdown-toggle">
                                                        <div class="vs__selected-options"> <input placeholder="System default"
                                                                                                  aria-autocomplete="list" aria-labelledby="vs1__combobox"
                                                                                                  aria-controls="vs1__listbox" type="search" autocomplete="off" class="vs__search">
                                                        </div>
                                                        <div class="vs__actions"><button type="button" title="Clear Selected"
                                                                                         aria-label="Clear Selected" class="vs__clear"
                                                                                         style="display: none;"><span>×</span></button> <span
                                        ...
                                        <div class="form-group publish-field publish-field__term_template template-fieldtype w-full">
                                            <div class="field-inner"><label for="field_term_template" class="publish-field-label"><span
                                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Term
                                  Template</span><!----><!----><!----><!----><button class="outline-none"
                                                                                     style="display: none;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                                                                                 class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                                  stroke-linejoin="round" stroke-width="1.5"
                                                ...
                                                <div class="help-block -mt-2">
                                                    <p>Set this taxonomy's default template. Terms can override this setting with a
                                                        <code>template</code> field.</p>
                                                </div>
                                            </div><!---->
                                            <div class="template-fieldtype-container">
                                                <div dir="auto" class="v-select vs--single vs--searchable" name="term_template">
                                                    <div id="vs2__combobox" role="combobox" aria-expanded="false" aria-owns="vs2__listbox"
                                                         aria-label="Search for option" class="vs__dropdown-toggle">
                                                        <div class="vs__selected-options"> <input placeholder="System default"
                                                                                                  aria-autocomplete="list" aria-labelledby="vs2__combobox"
                                                                                                  aria-controls="vs2__listbox" type="search" autocomplete="off" class="vs__search">
                                                        </div>
                                                        <div class="vs__actions"><button type="button" title="Clear Selected"
                                                                                         aria-label="Clear Selected" class="vs__clear"
                                                                                         style="display: none;"><span>×</span></button> <span
                                        ...
                                        <div class="form-group publish-field publish-field__layout template-fieldtype w-full">
                                            <div class="field-inner"><label for="field_layout" class="publish-field-label"><span
                                                ...
                                                <div class="help-block -mt-2">
                                                    <p>Set this taxonomy's default layout. Terms can override this setting with a
                                                        <code>layout</code> field.</p>
                                                </div>
                                            </div><!---->
                                            <div class="template-fieldtype-container">
                                      ...
                                      layout
                                                                <!----></span> <input aria-autocomplete="list" aria-labelledby="vs3__combobox"
                                                                                      aria-controls="vs3__listbox" type="search" autocomplete="off" class="vs__search">
                                                        </div>
                                                        <div class="vs__actions"><button type="button" title="Clear Selected"
