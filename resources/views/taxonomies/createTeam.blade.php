...
@section('content')
    <title>Taxonomies Create Team :: Cedar</title>
    <div class="page-wrapper max-w-3xl">
        <div>
            ...
            <div class="flex items-center mb-6">
                <h1 class="flex-1">
                    <div class="flex items-center"><!----><span>Create</span></div>
                </h1><!----><!---->
                    ...
                    <div>
                        <div>
                            <div class="tabs-container flex items-center">
                                <div role="tablist" aria-label="Edit Content" class="publish-tabs tabs"><button role="tab"
                                                                                                                id="MainTab" aria-controls="MainTabPanel" aria-selected="true" tabindex="0"
                            ...
                            <div class="publish-tab-outer">
                                <div class="publish-tab-wrapper w-full min-w-0">
                                    <div data-tab-handle="main" tabindex="0" class="publish-tab tab-panel w-full" role="tabpanel"
                                         id="MainTabPanel" aria-labelledby="MainTab">
                                                        ...
                                                        <div class="form-group publish-field publish-field__title text-fieldtype w-full">
                                                            ...
                                                            <div class="flex items-center">
                                                                <div class="input-group"><!----><input id="field_title" name="title" type="text"
                                                                                                       autofocus="autofocus" class="input-text"><!----></div><!---->
                                                            </div><!----><!---->
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="field-inner"><label for="field_content"
                                                                            ...
                                                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Content</span><!----><!----><!----><!----><button
                                                                            class="outline-none" style="display: none;"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                                                class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="field-inner"><label for="field_enabled"
                                                                        ...
                                                                        <div class="help-block -mt-2">
                                                                            <p>Disabling
                                                                                this section will exclude it from reports and the sitemap, and prevent
                                                    ...
                                                    Inherit
                                                      ...
                                                      <path fill="currentColor"
                                                            d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z">
                                                                        ...
                                                                        <div class="flex-1">
                                                                            <div class="text-sm text-grey inherit-placeholder mt-1"> Home </div>
                                                                        </div>
                                                                    </div><!----><!---->
                                                                </div>
                                                                <div
                                                    ...
                                                    <div class="publish-fields @container">
                                                        <div class="form-group publish-field publish-field__slug slug-fieldtype w-full">
                                                            <div class="field-inner"><label for="field_slug" class="publish-field-label"><span
                                                                            class="rtl:ml-1 ltr:mr-1 v-popper--has-tooltip">Slug</span><i
                                                                            class="required rtl:ml-1 ltr:mr-1">*</i><!----><!----><!----><button
                                                                            class="outline-none" style="display: none;"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                                                class="h-4 w-4 rtl:ml-1.5 ltr:mr-1.5 mb-1 text-gray-600 v-popper--has-tooltip">
                                                            ...
                                                            <div>
                                                                <div class="flex items-center">
                                                                    <div class="input-group"><!----><input id="field_slug" type="text" dir="ltr"
                                                                                                           class="input-text font-mono text-xs" name=""><!----></div><!---->
                                                                </div>
                                                            </div><!----><!---->
                                                        </div>
                                                    </div>
